...
public class Cimletezo {
    ...
    private List<Integer> cimletek= Arrays.asList(20000, 10000, 5000, 2000, 1000, 500, 200, 100, 50, 20, 10, 5);

    public HashMap<Integer, Integer> cimletezoMethod(int osszeg) {
